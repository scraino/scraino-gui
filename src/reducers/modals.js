...
const MODAL_AKARI_SAVE = 'akariSave';
const MODAL_AKARI_HELP = 'akariHelp';
...
const initialState = {
    ...
    [MODAL_AKARI_SAVE]: false,
    [MODAL_AKARI_HELP]: false
};
...
const openAkariSave = function () {
    return openModal(MODAL_AKARI_SAVE);
};
const closeAkariSave = function () {
    return closeModal(MODAL_AKARI_SAVE);
};
const openAkariHelp = function () {
    return openModal(MODAL_AKARI_HELP);
};
const closeAkariHelp = function () {
    return closeModal(MODAL_AKARI_HELP);
};
export {
    reducer as default,
