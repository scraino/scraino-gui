...
const control_off = function () {
    return `
    <category name="%{BKY_CATEGORY_CONTROL}" id="control" colour="#FFAB19" secondaryColour="#CF8B17">
        <block type="control_wait_off">
            <value name="DURATION">
                <shadow type="math_positive_number">
                    <field name="NUM">1</field>
                </shadow>
...
const operators_off = function () {
    ...
    <category name="%{BKY_CATEGORY_OPERATORS}" id="operators" colour="#40BF4A" secondaryColour="#389438">
        ...
        <block type="operator_bitwise_not_off">
            <value name="NUM">
                <shadow type="math_number">
                    <field name="NUM"/>
                </shadow>
 ...
 */
const makeToolboxXML = function (isStage, targetId, categoriesXML, codePanelOpen) {
    const gap = [categorySeparator];

    const everything = codePanelOpen ? [
        xmlOpen,
        control_off(isStage, targetId), gap,
        operators_off(isStage, targetId), gap,
        variables_off(isStage, targetId), gap,
