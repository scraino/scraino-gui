...
const mapStateToProps = state => ({
    ...
    akariSaveVisible: state.scratchGui.modals.akariSave,
    akariHelpVisible: state.scratchGui.modals.akariHelp,
    isAboutMenu: state.scratchGui.akari.isAboutMenu,
...
const mapDispatchToProps = dispatch => ({
    ...
    onRequestCloseAkariSave: () => dispatch(closeAkariSave()),
    onRequestCloseAkariHelp: () => dispatch(closeAkariHelp())
});
