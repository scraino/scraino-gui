                    ...
                    {this.getFilteredData().map((dataItem, index) => {
                        ...
                        if (dataItem.md5) {
                            if (process.env.NODE_ENV === 'production') {
                                scratchURL = `../../../../akari/${dataItem.ext ? 'examples' : 'assets'}/${dataItem.md5}`;
                            } else {
                                scratchURL = `https://cdn.assets.scratch.mit.edu/internalapi/asset/${dataItem.md5}/get/`;
                            }
                        } else {
                            scratchURL = dataItem.rawURL;
                        }
                        return (
                            <LibraryItem
